...
//     numbers_squared.push(newNumber)
// }
// console.log(numbers_squared)


// 3   Создать переменную last_elem и передать в нее последний элемент из сформированного массива numbers_squared 
// (обратиться к элементу массива по индексу)

// const last_elem = []
// const newElement = numbers[6]
// last_elem.push(newElement)
